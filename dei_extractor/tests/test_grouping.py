#!/usr/bin/env python3
"""
Test suite for DEI data grouping functionality.

This module contains tests for grouping and categorizing DEI data
based on various criteria and business rules.
"""
...
def create_test_data():
    ...
    test_data = [
        ...
        {
            "ΑρΠαροχής": "9876543210",
            "ΑρΛογαριασμού": "222222222",
            "ΗμΈκδοσης": "02/01/2024",
            "ΚατηγορίαΤιμολογίου": "Επαγγελματικό",
            "Εκαθαριστικός": True,
        },
        {
            "ΑρΠαροχής": "1234567890",
            "ΑρΛογαριασμού": "333333333",
            "ΗμΈκδοσης": "03/01/2024",
            "ΚατηγορίαΤιμολογίου": "ΦΟΠ",
            "Εκαθαριστικός": True,
        },
        {
            "ΑρΠαροχής": "5555555555",
            "ΑρΛογαριασμού": "444444444",
            "ΗμΈκδοσης": "04/01/2024",
            "ΚατηγορίαΤιμολογίου": "Επαγγελματικό",
            "Εκαθαριστικός": True,
        },
        {
            "ΑρΠαροχής": "9876543210",
            "ΑρΛογαριασμού": "555555555",
            "ΗμΈκδοσης": "05/01/2024",
            "ΚατηγορίαΤιμολογίου": "ΦΟΠ",
            "Εκαθαριστικός": True,
        },
        {
            "ΑρΠαροχής": "1111111111",
            "ΑρΛογαριασμού": "666666666",
            "ΗμΈκδοσης": "06/01/2024",
            "ΚατηγορίαΤιμολογίου": "Επαγγελματικό",
            "Εκαθαριστικός": True,
        },
    ]
